# Sonic Anemometer Ingest Pipeline Ingestion Pipeline

The Sonic Anemometer Ingest Pipeline ingestion pipeline was created from a cookiecutter template. This README file contains
